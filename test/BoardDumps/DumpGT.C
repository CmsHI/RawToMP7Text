...
void DumpGT(int MaxBX=100,int option=0,bool isverbose=true){

  TString filename;
  TString folder;
  //if(option==0) {folder="/Users/icali/Layer2/FWTest"; filename="emu_canonical_centralJets.txt";}
  if(option==0) {folder="/Users/icali/Layer2/FWTest"; filename="output_fiber_0_spaced.dat";}
  ...
  FILE *fp = fopen(Form("%s/%s",folder.Data(),filename.Data()),"read");
